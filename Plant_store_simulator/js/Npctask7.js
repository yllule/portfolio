class Npctask7 extends Phaser.Scene {
    ...
    create() {
        ...
        this.plant4 = this.add.image(this.width/2, 350, 'p4a');

        //making the sprites 1.5x bigger...looks pixelated but idk the original size is too small
        this.plant4.setScale(1.5);

        //makes plant sprites interactible
        this.plant4.setInteractive();

        this.input.setDraggable(this.plant4);
